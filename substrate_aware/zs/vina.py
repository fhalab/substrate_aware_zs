...
from substrate_aware.global_param import LIB_INFO_DICT, ENZYME_INFO_DICT, AA_DICT
from substrate_aware.preprocess import ZSData
from substrate_aware.chem_helper import protonate_smiles, apply_mutation
...
class VinaResults(ZSData):
    def __init__(
        ...
        - input_csv (str): The input CSV file, with `var_col_name` column
            ie. /disk2/fli/substrate_aware/data/meta/not_scaled/PfTrpB-4bromo.csv
